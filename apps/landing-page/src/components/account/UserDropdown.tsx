  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      <button
        ...
        aria-haspopup="true"
        className="flex items-center gap-2 px-3 py-2 rounded-md bg-[var(--pyre-blue)] text-[var(--pyre-creme)] hover:opacity-90 transition-opacity"
      >
        <span className="w-7 h-7 rounded-full bg-[var(--pyre-creme)]/20 flex items-center justify-center text-sm font-mono-bold">
          {initials}
        </span>
        <span className="hidden sm:inline font-mono-bold text-sm uppercase tracking-wide">
          {user.firstName}
        </span>
        {/* Chevron */}
        <svg
