...
describe('shapeShifts', () => {
  it('orders shifts by date then start, names the crew, and marks the asker', () => {
    const shaped = shapeShifts(
      ...
      [
        assignment({ id: 'a2', shift_id: 's1', staff_id: 'ari', starts_at: '07:30:00', ends_at: '09:30:00', duties: ['setup_a'] }),
    ...
    expect(morning.crew).toEqual([
      { name: 'Ari', duties: ['setup_a'], startsAt: '07:30', endsAt: '09:30', hours: 2, isMe: false },
      { name: 'Sam', duties: ['host', 'breakdown_b'], startsAt: '07:30', endsAt: '13:00', hours: 5.5, isMe: true },
    ]);
