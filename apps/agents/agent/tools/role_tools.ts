...
//
// The defineTool calls must sit lexically inside a block-bodied handler:
// eve's bundler transform only hoists executes it finds by walking the
// handler's own body, and it skips expression-bodied arrows. Tools built in a
