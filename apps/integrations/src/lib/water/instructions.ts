    ...
    sections: [
      {
        ...
        steps: [
          ...
          'Remove the filter basket and filter cover and lift the cartridge out',
          'Hose the filter down, fanning each pleat open as you go. Use water only — no pressure washer, no soap, no solvents.',
          'Check the pleats of the filter as you go: torn, flattened, or  discolored after a rinse means the cartridge is due to be changed, not rinsed again.',
          'Seat the cartridge back in, replace the filter cover and return the filter basket. ',
          'Restore power and run the pumps until the jets are strong and steady.',
          'Log it here as a filter entry, and note anything unusual.',
        ],
      },
      {
        heading: 'Change',
        steps: [
          ...
          'Drop in the new cartridge, replace the filter cover and return the filter basket.',
          'Restore power, run the pumps until the jets are strong and steady.',
          'Log it as a filter entry set to Changed, and remove it from inventory.',
        ],
      },
    ],
    footnote:
