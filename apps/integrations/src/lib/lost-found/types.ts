...
//
// Areas are borrowed wholesale from the incident taxonomy rather than
// redefined: it is the same site, and two tools describing the same bench
// differently would make both harder to search.

export { AREA_LABELS, areaLabel, INCIDENT_AREAS as LOST_FOUND_AREAS } from '@/lib/incidents/types';
