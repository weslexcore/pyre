    ...
    items: [
      {
        ...
        bullets: ['Melt away daily anxieties and make space to reconnect. Improve blood flow, sleep better, make a new friend. You’ll feel better than when you walked in. '],
      ...
      },
      {
        ...
        description:
          'A blank canvas.',
        bullets: ['The ancient power of sauna and cold bathing blended with new modalities. Sound baths, breathwork, drumming, guided meditations, communal healing; a new way to connect. '],
