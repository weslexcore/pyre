...
Write the plan into an docs/features/<N>_SHORT_DESCRIPTION_PLAN.md file with either the same feature number as the passed in brief or the next available feature number (starting with 0001)